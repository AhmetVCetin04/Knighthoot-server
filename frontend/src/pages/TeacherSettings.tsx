...
function useCurrentUser() {
  return useMemo(() => {
    try {
      ...
      if (!raw) return { username: "—", role: "Teacher", email: null };
...
export default function TeacherSettingsPage() {
  ...
  return (
    // Note: Assuming a layout component wraps this and handles the sidebar offset
      ...
      <div className="settings-container">
        ...
        <section className="settings-card">
          ...
          <div className="settings-narrow">
            ...
            <button 
              type="button" 
              className="primary-btn" // ⬅️ USE WORKING CSS CLASS
        ...
        <section className="settings-card danger">
          ...
          <div className="settings-narrow">
            ...
            <button
              className="danger-btn" // ⬅️ USE WORKING CSS CLASS
